...
PRESETS = {
    ...
    "Pee_group": "The women in the photo are peeing. Remove their underwear or clothes they are wearing on their bottom halves and their vaginas are visible. the women have no trousers or skirts on and they are naked from the waist down. From each their vaginas a thin stream of pee is visible and it hits the floor making a small puddle.Ensure the face from the original image remains perfectly intact, preserving the exact likeness as the top priority. Maintain the original image quality, including any lower camera quality or artifacts.",
